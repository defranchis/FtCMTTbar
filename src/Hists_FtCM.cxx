...
Hists_FtCM::Hists_FtCM(Context & ctx, const string & dirname): Hists(ctx, dirname){
...
template<typename T>
double m_groomed2T(const T & topjet){
...
double m_groomed2(const TopJet & topjet){
  return m_groomed2T<TopJet>(topjet);
}

void Hists_FtCM::fill(const Event & event){
