...
FtCMTTbarPreSelectionHists::FtCMTTbarPreSelectionHists(Context & ctx, const string & dirname): Hists(ctx, dirname){
...
void FtCMTTbarPreSelectionHists::fill(const Event & event){
...
FtCMTTbarPreSelectionHists::~FtCMTTbarPreSelectionHists(){}
