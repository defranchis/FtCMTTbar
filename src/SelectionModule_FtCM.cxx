...
namespace uhh2examples {
   ...
   */
  class SelectionModule_FtCM: public AnalysisModule {
  public:
    
    explicit SelectionModule_FtCM(Context & ctx);
  ...
  SelectionModule_FtCM::SelectionModule_FtCM(Context & ctx): selection(ctx, "selection") {
  ...
  bool SelectionModule_FtCM::process(Event & event) {
  ...
  UHH2_REGISTER_ANALYSIS_MODULE(SelectionModule_FtCM)
