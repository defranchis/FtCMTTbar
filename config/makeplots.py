...
histogram_xaxes = ["CSVv2 discriminator", "particle ID", "Track p [GeV]", "#eta", "#Delta #eta(track,jet axis)", "#Delta R(track,jet axis)", "3D IP of tracks", "3D IP significance of tracks", "2D IP of tracks", "2D IP significance of tracks", "L_{d} [cm]", "#chi^2_{track}", "Number of hits", "Number of pixel hits","pT relative to jet axis [GeV] ","parallel momentum along jet axis [GeV] ","normalized pT relative to jet axis","normalized parallel momentum along jet axis","d [cm]"," d/{#sigma d}","d_{ghost} [cm]","d_{ghost}/{#sigma d_{ghost}} "," weight of track participation in ghost track fit", "dist_T(PV,SV) [cm]", "dist_T/#sigma_{dist_T}(PV,SV)", "dist(PV,SV) [cm]", "SV 3D flight distance significance", "#Delta#phi", "Number of SV", "N_{tracks}", "inv. mass [GeV]", "#chi^2_{SV}", "N_{dof}", "#chi^2/N_{dof}(SV)", "category", "inv. mass [GeV/c^{2}]", "E_{SV}/E_{tot}", "IP/#sigma_{IP}","Number of selected tracks in the jets","pT [GeV]"]
